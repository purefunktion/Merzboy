...
MainTileSetup:
    ...
    ld hl, $98CD        ; On screen position map address for RA tile in RAND sign
    ...
    inc a
    ld [hl], a
    ld hl, $98C6        ; ON starts here
    ld a, $0C           ; Tile 12
    ld [hli], a
    inc a
    ld [hl], a
    ld hl, $9926        ; OFF starts here
    ld a, $0E           ; Tile 14
    ld [hli], a
    inc a
    ld [hl], a
...
HandlePressA:
    ...
    cp a, 0             ; ComPare value in a to 0 https://rgbds.gbdev.io/docs/v0.8.0/gbz80.7#CP_A,n8
